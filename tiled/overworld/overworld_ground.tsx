...
<tileset version="1.2" tiledversion="1.3.1" name="overworld_ground" tilewidth="16" tileheight="16" tilecount="45" columns="5">
 <image source="../images/ground/overworld_ground.png" width="80" height="144"/>
 <terraintypes>
  <terrain name="Grass" tile="6"/>
  <terrain name="Dead Grass" tile="21"/>
  <terrain name="Path" tile="36"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
